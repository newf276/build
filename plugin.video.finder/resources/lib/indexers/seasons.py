...
from modules.utils import TaskPool, adjust_premiered_date, get_datetime
from modules.watched_status import get_database, get_progress_status_season, get_watched_status_season, watched_info_season
	...
	def _process():
		...
		for item in season_data:
			try:
				...
				try:
					premiered = adjust_premiered_date(air_date, adjust_hours)[1]
				except:
					premiered = ""
				unaired = aired_eps == 0
				...
				options_params = build_url(
					{"mode": "options_menu_choice", "content": "season", "tmdb_id": tmdb_id, "poster": show_poster, "is_external": is_external}
				)
