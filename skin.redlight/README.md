# Redlight Skin for Kodi Omega

**IMPORTANT INFO:** I am currently not accepting **ANY** feature requests.

Redlight is a modded version of the default Estuary skin, specifically designed for FEN users. It includes several new features and adjustments to pre-existing views, a new UI, viewtypes, customizable widgets, and a new default colors theme.

Below you'll find some information about the [differences](#redlight-vs-default-estuary-skin) between Estuary and Redlight along with some screenshots and a detailed [setup guide](#setup-guide) of the skin.


## Redlight vs Default Estuary Skin

Here are some of the key differences between Redlight and the default Estuary skin.

* **New UI Experience**: Redlight introduces an updated modern UI.
...
* **New viewtypes**: Redlight introduces "WideInfoWall" and "WideWall" viewtypes.

  ![Viewtypes WideInfoWall](resources/images/viewtypes.jpg)

* **Customizable Widgets**: Redlight allows you to customize widgets and category widgets for movies, tvshows, and episodes.

  ![Customizable Widgets](resources/images/customizable_widgets.jpg)

* **Custom Stacked Widgets**: Redlight introduces stacked widgets for movies and tvshows.

  ![Stacked Widgets](resources/images/stacked_widgets.jpg)

* **Custom Search Window**: Redlight introduces a search window to simultaneously search multiple categories including TRAKT Lists.

  ![Search Window](resources/images/search_window.jpg)

  ![Search Window](resources/images/search_window1.jpg)

* **InfoPanel with Ratings**: Redlight introduces a new InfoPanel with optional displaying of ratings for widgets. The ratings can be dislayed in the InfoPanel, widget labels, or both.
...
Now click Install from repository » Find and click ivarbrandt's Repository » Look and feel » Skin » Redlight » click to install it.
...
<!-- If you encounter any issues while using Redlight, please follow these guidelines before opening an Issue:
