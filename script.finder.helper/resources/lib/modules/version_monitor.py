...
PROFILE_PATH = os.path.join(
    translatePath("special://userdata/addon_data/script.finder.helper"),
...
def generated_xml_missing():
    ...
    required_files = (
        "script-finder-widget_movies.xml",
        "script-finder-widget_tvshows.xml",
        "script-finder-widget_custom1.xml",
        "script-finder-widget_custom2.xml",
        "script-finder-widget_custom3.xml",
        "script-finder-widget_custom4.xml",
        "script-finder-widget_custom5.xml",
        "script-finder-widget_custom6.xml",
        "script-finder-main_menu_movies.xml",
        "script-finder-main_menu_tvshows.xml",
        "script-finder-main_menu_custom1.xml",
        "script-finder-main_menu_custom2.xml",
        "script-finder-main_menu_custom3.xml",
        "script-finder-main_menu_custom4.xml",
        "script-finder-main_menu_custom5.xml",
        "script-finder-main_menu_custom6.xml",
    )
