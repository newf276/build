...
from newfsscrapers.modules.control import setting as getSetting, addonInfo
...
class source:
	...
	def __init__(self):
		...
		self.language = ['en']
		self.headers = {'user-agent': f"newfsscrapers/{addonInfo('version')}", 'x-api-key': self.token}
